...
| `autoBitrateProfile` | [`AutomaticBitrateProfile?`](#automaticbitrateprofile) |          -           | iOS, Android | The profile to use for the video’s automatic bitrate algorithm. This has **no** effect if `useAutoBitrate` is `false`                                                                       |
